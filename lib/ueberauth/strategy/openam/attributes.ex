defmodule Ueberauth.Strategy.OpenAM.Attributes do
  ...
  defp parser do
    ...
    fn
      ["userdetails.attribute.name", new_key], acc ->
        Map.put(acc, :_, String.to_atom(new_key))

      ["userdetails.attribute.value", value], acc ->
        Map.update(acc, acc[:_], value, &update.(&1, value))
